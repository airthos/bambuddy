export default {
  ...
  settings: {
    ...
    sentryEnabled: 'Enable Sentry mode',
    sentryEnabledDescription: 'Record camera frames for each print job, from just before it starts to shortly after it ends, for later playback on the Cameras page.',
    sentryRetentionDays: 'Keep recordings for',
    sentryRetentionDaysHelp: 'Recordings older than this are deleted automatically. Recordings flagged "keep forever" are never deleted by this.',
    sentryDays: 'days',
    sentryMinutes: 'minutes',
    sentrySeconds: 'seconds',
    sentryPreRoll: 'Pre-roll',
    sentryPreRollHelp: 'Recording starts this many minutes before the print actually begins.',
    sentryPostRoll: 'Post-roll',
    sentryPostRollHelp: 'Recording continues this many seconds after the print finishes, fails, or is cancelled.',
    sentryNotImplementedNotice: 'Sentry mode only supports P1/A1-series (chamber-image) cameras so far. Pre-roll is best-effort — recording starts as early as the print pipeline allows, not literally N minutes ahead, since nothing is recorded while a printer sits idle between jobs.',
    sentryStorageTitle: 'Storage Usage',
    sentryStorageDescription: 'Breakdown of recorded footage by printer',
    sentryDiskBarTitle: 'Recordings vs. total disk',
    sentryDiskRecordings: 'Recordings',
    sentryDiskOtherUsed: 'Other used',
    sentryDiskFree: 'Free',
    sentryDiskCaption: '{{used}} of {{total}} used ({{percent}}% of disk)',
    sentryClearRecordings: 'Clear Recordings',
    sentryClearRecordingsConfirm: 'Delete all recordings that aren\'t flagged "keep forever"? This cannot be undone.',
    sentryNoRecordings: 'No recordings yet.',
    sentryKeptForeverAmount: '{{amount}} kept forever',
    sentryRecordingsTitle: 'Recordings',
    sentryRecordingsDescription: 'Recent recordings — flag one to keep it forever, or delete it now.',
    sentryKeepForever: 'Keep forever',
    sentryFrames: 'frames',
    sentryDeleteRecording: 'Delete recording',
    sentryRecordingDeleted: 'Recording deleted',
    sentryRecordingsCleared: '{{count}} recording(s) cleared',
    sentryIntervalTitle: 'Interval Snapshots',
    sentryIntervalDescription: 'Independent of per-job recording — captures one snapshot per active printer on a fixed schedule, regardless of print state. Good for a basic ambient check-in even when nothing is printing.',
    sentryIntervalMinutes: 'Capture every',
    sentryIntervalRetention: 'Keep snapshots for',
    sentryIntervalEstimate: 'Estimated: {{perDay}}/day, {{perWeek}}/week — about {{total}} total kept at a time ({{days}}-day retention).',
  ...
  camera: {
    ...
    timeline: {
      viewGrid: 'Grid',
      viewDetail: 'Detail',
      mockNotice: 'Preview data — recording is not implemented yet, this shows the intended UI with mocked sessions.',
      printing: 'Printing',
      idle: 'Idle',
      now: 'now',
      hoursAgo: '{{count}}h ago',
      selectPrompt: 'Select a job on the timeline below to load its recording',
      ...
      statusFailed: 'Failed',
      incompleteRecording: 'Incomplete recording',
      buffered: 'Buffered',
      buffering: 'Buffering…',
      download: 'Download 100x timelapse (MP4)',
      downloadFrame: 'Download current frame (full res)',
      speedLabel: 'Speed',
